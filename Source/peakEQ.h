...
class peakEQ : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("PeakEqualizer");
		...
		ui_interface->addHorizontalSlider("Peak Frequency", &fHslider0, 440.0f, 50.0f, 11000.0f, 0.00999999978f);
		ui_interface->declare(&fHslider1, "2", "");
		ui_interface->declare(&fHslider1, "acc", "2 1 -10 0 10");
		ui_interface->declare(&fHslider1, "style", "knob");
		ui_interface->declare(&fHslider1, "unit", "dB");
		ui_interface->addHorizontalSlider("Level", &fHslider1, 0.0f, -40.0f, 32.0f, 0.00999999978f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow1 = max(-40.0f, min(32.0f, float(fHslider1)));
		int iSlow2 = (fSlow1 > 0.0f);
		float fSlow3 = (fConst3 * powf(10.0f, (0.0500000007f * fabsf(fSlow1))));
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp6 = (2.0f * (fRec0[1] * (1.0f - (1.0f / faustpower2_f(fTemp0)))));
			float fTemp7 = (((fTemp1 + fTemp5) / fTemp0) + 1.0f);
			fRec0[0] = (float(input0[i]) - (((fRec0[2] * (((fTemp1 - fTemp5) / fTemp0) + 1.0f)) + fTemp6) / fTemp7));
			float fTemp8 = (iSlow2?fTemp3:fTemp4);
			output0[i] = FAUSTFLOAT(((fTemp6 + ((fRec0[0] * (((fTemp1 + fTemp8) / fTemp0) + 1.0f)) + (fRec0[2] * (((fTemp1 - fTemp8) / fTemp0) + 1.0f)))) / fTemp7));
			fRec1[1] = fRec1[0];
			fRec2[1] = fRec2[0];
			fRec0[2] = fRec0[1];
			fRec0[1] = fRec0[0];
